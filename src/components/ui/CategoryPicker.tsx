...
export default function CategoryPicker({
  ...
  return (
    ...
    >
      ...
      {/* Sheet */}
      <div className="relative w-full max-w-md mx-auto bg-white rounded-t-3xl shadow-2xl overflow-hidden">
        ...
        {mode === "list" ? (
          <>
            ...
            {/* New category button */}
            <div className="px-3 pb-6 pt-1 border-t border-stone-100">
              <button
                onClick={() => setMode("new")}
                className="w-full flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-stone-50 active:bg-stone-100 transition-colors text-left"
              >
