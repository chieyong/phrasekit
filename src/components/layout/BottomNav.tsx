...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-stone-100 safe-area-bottom">
          ...
          if (item.featured) {
            return (
              ...
              >
                ...
                {isActive && (
                  <span className="absolute top-0 left-1/2 -translate-x-1/2 w-5 h-0.5 bg-stone-900 rounded-full" />
                )}
              </Link>
            );
          }
